...
def analyze_single_file_or_directory(filepath, local_rules):
  ...
  rit['yara_scan'] = start_yara_scanner(YaraScanner(), [filepath], report_filename)
  ...
  rit['hash_scan'] = start_hash_scanner(HashScanner(), [filepath], report_filename)
