...
yara_whitelist = ["powershell", "Misc_Suspicious_Strings", "SurtrStrings", "Surtr", "BASE64_table", "Big_Numbers0", "Big_Numbers1", "Big_Numbers2", "Big_Numbers3", "Big_Numbers4", "Big_Numbers5", "BLOWFISH_Constants", "Borland", "Chacha_128_constant", "Chacha_256_constant", "CRC16_table", "CRC32b_poly_Constant", "CRC32c_poly_Constant", "CRC32_poly_Constant", "CRC32_table", "cred_ff", "DES_Long", "DES_sbox", "ecc_order", "ldpreload", "maldoc_getEIP_method_1", "maldoc_OLE_file_magic_number", "MD5_Constants", "PlugX", "ppaction", "Prime_Constants_long", "Qemu_Detection", "RIPEMD160_Constants", "SEH__vectored", "SHA1_Constants", "SHA2_BLAKE2_IVs", "SHA3_constants", "SHA512_Constants", "SipHash_big_endian_constants", "spreading_file", "Str_Win32_Http_API", "Str_Win32_Winsock2_Library", "System_Tools", "ThreadControl__Context", "url", "VirtualBox_Detection", "vmdetect", "vmdetect_misc", "VMWare_Detection", "WHIRLPOOL_Constants", "win_mutex", "win_registry", "with_images", "without_attachments", "without_images", "without_urls", "with_urls"]
