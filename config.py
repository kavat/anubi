...
from core.syscall_scanner import SysCallScan
...
anubi_path = {
  ...
  "stats_path": "{}/stats".format(application_path),
...
path_logger_anubi_syscall = "{}/anubi_syscall.log".format(base_log)
...
loggers["resources"]["logger_anubi_hash"] = AnubiLogger("anubi_hash", path_logger_anubi_hash, log_to_stdout, "info")
loggers["resources"]["logger_anubi_syscall"] = AnubiLogger("anubi_syscall", path_logger_anubi_syscall, log_to_stdout, "info")
...
loggers["assoc"]["syscall"] = "logger_anubi_syscall"
...
updater_syscall = AnubiUpdater()

yara_scan = YaraScan()
hash_scan = HashScan()
syscall_scan = SysCallScan()
ip_check = IpCheck()
voyeur_spy = FsSpy()
